...
use ErpNET\Auth\v1\Entities\Teams\CanJoinTeams;
use ErpNET\Auth\v1\Entities\Subscriptions\Plans;
use ErpNET\Saas\v1\Services\Ux\Settings\TeamTabs;
use ErpNET\Saas\v1\Services\Ux\Settings\DashboardTabs;
use ErpNET\Saas\v1\Services\Auth\TwoFactor\Authy;

class ErpnetSparkService
{
    /**
